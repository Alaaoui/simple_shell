...
/**
 * get_history_file - retrives file history
 ...
 * @info: the parameter struct value
 *
 ...
 *
 * Return: file hist on success, 0 otherwise
 */
...
/**
 * renumber_history - renumbers the history of linked list
